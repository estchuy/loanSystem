    ...
    <body>
        ...
        <div class="wrapper-page">
            <div class="ex-page-content text-center">
                ...
                <h2>Who0ps! Pagina No Encontrada</h2><br>
                <p class="text-muted">Esta Pagina no se puede Encontrar o esta Perdida.</p>
                <br>
                <a class="btn btn-warning btn-custom waves-effect waves-light" href="http://<?php echo $_SERVER['SERVER_NAME']; ?>"> Regresar a Inicio</a>
